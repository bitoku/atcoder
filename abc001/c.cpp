...
int main() {
    ...
    dis = (int)round((double)dis / 6);
    if (0 <= dis && dis < 3) w = 0;
    else if (3 <= dis && dis < 16) w = 1;
    else if (16 <= dis && dis < 34) w = 2;
    else if (34 <= dis && dis < 55) w = 3;
    else if (55 <= dis && dis < 80) w = 4;
    else if (80 <= dis && dis < 108) w = 5;
    else if (108 <= dis && dis < 139) w = 6;
    else if (139 <= dis && dis < 172) w = 7;
    else if (172 <= dis && dis < 208) w = 8;
    else if (208 <= dis && dis < 245) w = 9;
    else if (245 <= dis && dis < 285) w = 10;
    else if (285 <= dis && dis < 327) w = 11;
